...
class Settings:  # pylint: disable=too-few-public-methods
    ...
    MINER_PAGE_ISOLATION_ENABLED = env_bool('MINER_PAGE_ISOLATION_ENABLED', True)
    MINER_PAGE_HARD_TIMEOUT_SECONDS = int(os.getenv('MINER_PAGE_HARD_TIMEOUT_SECONDS', '45'))
    ...
    BODY_READY_TIMEOUT_MS = int(os.getenv('BODY_READY_TIMEOUT_MS', '1000'))
    TEXT_FALLBACK_TIMEOUT_MS = int(os.getenv('TEXT_FALLBACK_TIMEOUT_MS', '1000'))
    HREF_EXTRACTION_TIMEOUT_MS = int(os.getenv('HREF_EXTRACTION_TIMEOUT_MS', '1000'))
    PLAYWRIGHT_DEFAULT_TIMEOUT_MS = int(os.getenv('PLAYWRIGHT_DEFAULT_TIMEOUT_MS', '5000'))
    REQUESTER_TOTAL_TIMEOUT_SECONDS = int(os.getenv('REQUESTER_TOTAL_TIMEOUT_SECONDS', '30'))
